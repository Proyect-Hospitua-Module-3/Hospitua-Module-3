...
**Prueba independiente**: Se puede registrar el check-out de una reserva marcada con un canal OTA y un porcentaje de comisión suministrado por Módulo 2, y verificar que el ingreso neto excluya exactamente ese porcentaje del valor de hospedaje.

**Escenarios de aceptación**:

1. **Escenario**: Reserva con intermediario y comisión suministrada por Módulo 2
   - **Dado** que el check-out corresponde a una reserva de canal OTA y Módulo 2 suministra el porcentaje de comisión pactado
...
3. **Escenario**: Reserva con intermediario sin porcentaje de comisión suministrado
   - **Dado** que el check-out corresponde a una reserva de canal OTA pero Módulo 2 no suministra un porcentaje de comisión válido
...
- **FR-005**: El sistema DEBE obtener de Módulo 2 el porcentaje de comisión pactado cuando el canal de origen sea un intermediario OTA; el sistema no mantiene una tabla propia de convenios de comisión por OTA.
...
- **FR-014**: El sistema DEBE rechazar la generación de la liquidación cuando falte el valor de hospedaje o el porcentaje de comisión requerido para un canal OTA (suministrado por Módulo 2).
...
- **Liquidación**: Resultado del proceso de liquidación de una estancia; existe únicamente con estado `Final`, e incluye valor de hospedaje, comisión OTA aplicada (si corresponde), ingreso neto; la factura definitiva asociada la produce `Generar factura final`, que incluye (`<<include>>`) esta liquidación.
...
- **BR-010**: El canal de origen lo recibe Módulo 3 desde Módulo 1 en el evento de check-out, y el porcentaje de comisión lo suministra Módulo 2; Módulo 3 no los gestiona ni los corrige.
